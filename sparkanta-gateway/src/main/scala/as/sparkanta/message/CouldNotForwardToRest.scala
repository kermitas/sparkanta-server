...
class CouldNotForwardToRest(val forwardToRestServer: ForwardToRestServer, restAddress: IdentifiedInetSocketAddress, val exception: Exception) extends Serializable {
